...
In [yesterday’s “weekly”](/weekly-bookmarks-006/) I shared the new [MDN docs page for `@scope`](https://developer.mozilla.org/en-US/docs/Web/CSS/@scope) — a new CSS feature currently only available in Chromium-based browser.
...
<LiveExample class="require-at-scope" caption="A live example, showing how one of the rules does not apply, why intuitively, you might think it should.">
```css
@scope (.my-scope) {
	.inner {
		background: var(--PINK);
