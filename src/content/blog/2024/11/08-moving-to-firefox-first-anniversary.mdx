...
description: 'One year ago, I moved to Firefox. I’m still using it (the “Nightly” version). Mozilla has made some questionable moves since then. But, each time I look at alternatives, I am not entirely sure if there is any reason — for me — to move to something else.'
...
But, each time I look at alternatives, I am not entirely sure if there is any reason — for me — to move to something else.
