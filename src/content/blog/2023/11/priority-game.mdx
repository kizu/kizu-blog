...
But here we are — with them unlocking so many effects and use cases! And now that [they’re in Chrome Stable](https://blog.kizu.dev/scroll-driven-animations-in-stable-chrome/), let’s prioritize shipping them _everywhere_.
