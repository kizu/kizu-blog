...
description: 'For some reason, I had this misconception that Shadow DOM could be used with regular elements, I only ever tried it with the custom ones.'
