...
And so, it fails the success criterion. At least, literally: in some cases, like in an example above, it could be argued that the text is “big enough”. And, here is [a relevant comment](https://github.com/w3c/wcag/issues/1671#issuecomment-797178007) by [Mitchell Evan](https://github.com/mitchellevan) from a different (but related) WCAG issue [“Can large headings be exempt from Success Criterion 1.4.4 Resize text?”](https://github.com/w3c/wcag/issues/1671):
