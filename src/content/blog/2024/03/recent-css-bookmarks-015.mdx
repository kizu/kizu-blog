...
description: 'A compilation of 23 articles and posts about various topics: colors and themes, container queries, accesibility, grids, future CSS, and more.'
tags: ['CSS', 'bookmarks']
pubDate: '2024-04-04'
mastodonPostId: ''
...
- [“On popover accessibility: what the browser does and doesn’t do”](https://hidde.blog/popover-accessibility/) by [Hidde de Vries](https://hidde.blog/) — an article about the ways Popover API interacts with accessibility of the popovers and their associated buttons.
