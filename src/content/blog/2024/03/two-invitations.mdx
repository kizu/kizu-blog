...
description: 'In the last few weeks, I received two invitations: an invitation to speak at the next CSS Day, and an invitation to join the CSS Working Group as an Invited Expert.'
tags: ['CSS', 'Personal']
pubDate: '2024-03-09'
mastodonPostId: ''
current: {
