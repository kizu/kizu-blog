...
mastodonPostId: '115533026440139284'
...
## Update from 2025-11-12

After I published this post, [Miriam](https://www.miriamsuzanne.com/) noted that CSSWG already [resolved on this](https://github.com/w3c/csswg-drafts/issues/9192#issuecomment-1789850349) 2 years ago, and [Rune Lillesveen](https://social.vivaldi.net/@rune) [contributed WPT tests](https://github.com/web-platform-tests/wpt/pull/49093) a year ago, which, as also tested by me, are still [not passing](https://wpt.fyi/results/css/css-conditional/container-queries/query-container-name.html?label=experimental&label=master&aligned).
...
## Update from 2025-12-13

And now there will be a first implementation of the name-only container queries, thanks to [Anthony Frehner](https://frehner.me/) who submitted [a patch to WebKit](https://github.com/WebKit/WebKit/pull/54667) that is now merged! Looking at the code there — it really seems like a pretty simple thing, so, I hope, this will be in other browsers too sooner rather than later.

## Update from 2026-03-31

Since the last update:

- Anthony also pushed and merged a PR to Firefox!
- Rune opened [an intent to ship](https://groups.google.com/a/chromium.org/g/blink-dev/c/2czawrZacS8/m/F4wm1f9-AQAJ) it in Chrome, following Anthony’s work on this.

That mini-feature could get a pretty quick interop!
