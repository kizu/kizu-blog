...
tags: ['Fediverse', 'Mastodon', 'IndieWeb', 'Personal']
pubDate: '2023-11-06'
mastodonPostId: '111365587215205894'

current: {
	drink: 'Sweet herbal tea (it is camomile and honey, but I don’t sense it)',
	music: 'Sigur Rós — Ágætis Byrjun',
}
bandcamp: {
	track: '2312185836',
	link: 'https://sigurros.bandcamp.com/track/gaetis-byrjun-2',
}
---
