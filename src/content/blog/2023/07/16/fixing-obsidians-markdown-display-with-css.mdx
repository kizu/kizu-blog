...
In my previous blog post — [“<u>Apps with Presence on Mastodon</u>”](/apps-with-presence-on-mastodon) — I did write about what ended up being the decisive feature leading to me starting to use [Obsidian](https://obsidian.md/):
