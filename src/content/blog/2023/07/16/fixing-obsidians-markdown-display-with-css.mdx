...
description: 'I am sharing a CSS snippet I wrote for Obsidian, which makes the default Markdown display better for me by outputting the corresponding code symbols.'
pubDate: '2023-07-16'
...
import badVideo from './obsidian-md-bad.mp4';
...
import goodVideo from './obsidian-md-good.mp4';
